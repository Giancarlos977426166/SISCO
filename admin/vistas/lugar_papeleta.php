...
<div class="box-header with-border">
  <h1 class="box-title">Lugares Autorizados para las Papeletas <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-square"></i> Agregar</button></h1>
...
require 'footer.php';
 ?>
 <script src="scripts/lugar_papeleta.js"></script>
 <?php 
}
