...
<div class="box-header with-border">
  <h1 class="box-title">Personal <button class="btn btn-success" onclick="mostrarform(true)" id="btnagregar"><i class="fa fa-plus-square"></i> Agregar</button></h1>
...
<div class="panel-body" id="formularioregistros">
  <form action="" name="formulario" id="formulario" method="POST">
    ...
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
     ...
     <select name="iddepartamento" id="iddepartamento" class="form-control select-picker" data-live-search="true" required>
      
     </select>
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      <label for="">Cargo(*):</label>
     <select name="idcargo" id="idcargo" class="form-control select-picker" data-live-search="true" required>
      
     </select>
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      <label for="">Turno(*):</label>
     <select name="idturno" id="idturno" class="form-control select-picker" required>
    ...
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <input class="form-control" type="email" name="email" id="email" maxlength="70" placeholder="ejemplo@mail.com">
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      <label for="">DNI/Login(*):</label>
      <input class="form-control" type="text" name="login" id="login" maxlength="20" placeholder="DNI del usuario" required>
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12" id="claves">
      <label for="">Clave de ingreso/Contraseña(*):</label>
      <input class="form-control" type="password" name="clave" id="clave" maxlength="64" placeholder="Clave">
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12" id="claves">
      <label for="">Clave de asistencia/DNI(*):</label>
      <button class="btn btn-info" type="button" onclick="generar(6);" >Generar</button>
      <input class="form-control" type="text" name="codigo_asistencia" id="codigo_asistencia" maxlength="64" placeholder="Clave">
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
