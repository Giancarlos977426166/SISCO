...
<div class="box-header with-border" id="encabezado">
  <h1 class="box-title">Papeletas de Salida
    <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true, 1)"><i class="fa fa-plus-square"></i> Agregar</button></h1>
...
require 'footer.php';
 ?>
 <script src="scripts/papeleta.js"></script>
 <?php 
}
